defmodule DeliveryCenterApiWeb.OrderControllerTest do
  use DeliveryCenterApiWeb.ConnCase
  ...
  @invalid_attrs %{city: nil, complement: nil, country: nil, deliveryFee: nil, district: nil, dtOrderCreate: nil, externalCode: nil, latitude: nil, longitude: nil, number: nil, postalCode: nil, state: nil, storeId: nil, street: nil, subTotal: nil, total: nil}
  ...
  describe "index orders" do
    ...
    test"renders list of orders corretly", %{conn: conn} do
      post(conn, Routes.order_path(conn, :create), @create_attrs)
      response = get(conn, Routes.order_path(conn, :index))
      orders = json_response(response, 200)["data"]
  ...
  describe "create order" do
    ...
    test "renders order when data is valid", %{conn: conn} do
      ...
      order = json_response(conn, 201)["data"]
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post(conn, Routes.order_path(conn, :create), @invalid_attrs)
